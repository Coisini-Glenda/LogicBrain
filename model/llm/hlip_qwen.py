...
from ..hlip_vlm_arch import HLIPVLMMetaForCausalLM, HLIPVLMMetaModel
...
class VLMQwenModel(HLIPVLMMetaModel, Qwen3Model):
...
class VLMQwenForCausalLM(Qwen3ForCausalLM, HLIPVLMMetaForCausalLM):
    config_class = VLMQwenConfig
