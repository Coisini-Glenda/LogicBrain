...
from src.dataset.mllm_dataset import TherapyPrognosisDataset_HLIP
    ...
    for pred, label in zip(decoded_preds, decoded_labels):
        ...
        try:
            bert_score = bertscore.compute(
                ...
                lang="en", model_type="/home/Vicky/Brain_CT/output/roberta-large"
            )
...
def main():
    ...
    test_dataset = TherapyPrognosisDataset_HLIP(
    ...
    csv_output_path = os.path.join(args.output_dir, f"{model_name}_eval_tp_realtime.csv")
    ...
    if rank == 0:
        print("Starting Therapy Prognosis evaluation...")
    ...
    if rank == 0:
        ...
        if all_results:
            ...
            score_file = os.path.join(args.output_dir, f"{model_name}_tp_final_scores.json")
